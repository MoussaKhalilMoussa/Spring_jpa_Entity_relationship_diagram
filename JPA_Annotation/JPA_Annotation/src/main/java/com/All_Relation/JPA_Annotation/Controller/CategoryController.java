...
import com.All_Relation.JPA_Annotation.Service.CategoryService;
...
public class CategoryController {
    ...
    @PutMapping("/edit/{id}")
    public ResponseEntity<CategoryResponseDto> editCategory(@PathVariable final  CategoryRequestDto categoryRequestDto,
